class ComplexNumber:
    ...
    def __truediv__(self, other):
        ...
        real = (self.real_part * other.real_part + self.im_part * other.im_part) / divisor
        imaginary = (-self.real_part * other.im_part + other.real_part * self.im_part) / divisor
        return ComplexNumber(real, imaginary)
    ...
    def __str__(self):
        if self.im_part < 0:
            return "{} {} {}i".format(self.real_part, '-', abs(self.im_part))
        return "{} {} {}i".format(self.real_part, '+', abs(self.im_part))
